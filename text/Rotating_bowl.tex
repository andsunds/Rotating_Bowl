...
\resizebox{7.5cm}{!}{\input{fig1_parabola_code.tex}}
...
%The fact that the surface is parabolic can then be used optically. A parabolic mirror will reflect any vertically incoming light to the focal point of that parabola. This property was used by~\cite{Berg1990} to focus light into an optical image. There's even a telescopes, like the Large Zenith Telescope~\cite{LargeZenith}, which uses rotating mercury as the telescope's mirror. 

\begin{figure}\centering
\resizebox{4cm}{!}{\input{fig2_angles_code.tex}}
\caption{
...
\begin{figure*}
\centering
\resizebox{9cm}{!}{\input{fig3_rot_bowl_code.tex}}
\caption{
...
\begin{figure}
\centering
\resizebox{6cm}{!}{\input{fig4_rot_bowl_pic_code.tex}}
