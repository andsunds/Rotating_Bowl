...
\twocolumn[
  \begin{@twocolumnfalse}
    ...
    known focal point. By measuring the height of this focal point,
    $g$ could be determined to $9.78\pm0.13\,\unit{m/s^2}$, which is
    not bad compared to similar methods. 
    \end{abstract}
    \centerline{
      \line(1,0){360}
    }
